...
(()=>{
    ...
    function A(e, t, n) {
        ...
        var a = [];
        function l(e, n) {
            var o, r = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : "src", i = window.location.origin, s = H(U(window, e));
            try {
                for (s.s(); !(o = s.n()).done; ) {
                    var l = o.value;
                    if (!n || n(l)) {
                        var c = w(l, r);
                        c && !c.startsWith(t) && c.startsWith(i) && (c.startsWith("data:") || a.push(c))
                    }
                }
            } catch (e) {
                s.e(e)
    ...
    function N(e) {
        ...
        if (t.length > 0)
            for (var n = 0; n < t.length; n++)
                R(t[n]).classList.add("wb-highlight")
    }
    function j(e) {
        var t = O(window, e.target.href);
        if (t.length > 0)
    ...
    var V = function() {
        function e(t, n, o) {
            ...
            document.addEventListener("DOMContentLoaded", (function() {
                var e;
                r.enableSaveSnapshot((e = "logged-in-user",
        ...
        n = [{
            ...
            value: function(e) {
                ...
                v("POST", "/__wb/web-archive/", (function(e) {
            ...
            value: function() {
                arguments.length > 0 && void 0 !== arguments[0] && !arguments[0] ? (this.hide(["wm-save-snapshot-open", "wm-save-snapshot-in-progress"]),
                this.show("wm-sign-in")) : (this.show("wm-save-snapshot-open"),
                this.hide("wm-sign-in"))
            }
        }, {
            key: "show",
            value: function(e) {
    ...
    var Z, ee, te = window.JSON, ne = window.open, oe = window.Date, re = window.fetch, ie = document, se = document, ae = function(e) {
        return se.getElementById(e)
    };
    var le, ce = "/static/";
    function ue(e) {
        Z.classList.contains("wm-closed") ? (e && ee.classList.add("notice-only"),
        Z.classList.replace("wm-closed", "wm-open"),
        ee.style.display = "block",
        A(le, ce, ae)) : (Z.classList.replace("wm-open", "wm-closed"),
    ...
    window.__wm = {
        ...
        wombat: function(e, n, r, i, s, a) {
            var l = "".concat(r).concat(i, "/")
              , c = new URL(r)
              , u = r.replace(/^https?:/, "")
              , h = ["http://analytics.archive.org/", "https://analytics.archive.org/", "//analytics.archive.org/", "/__wb/", "/".concat(i, "/"), r, u];
            s.startsWith(r) || s.startsWith(u) || (h.push(s),
            /^\/\//.test(s) ? h.push(c.protocol + s) : /^\//.test(s));
            var f = new URL(e)
              , p = {
                url: e,
                timestamp: n,
        ...
        bt: function(e, t, n, o, r, s, a, l, c, u, h) {
            var f;
            ce = c || "/static/";
            var p, d, m, y = "/" + (r || "web") + "/", g = C(le = a), w = g.getUTCFullYear(), b = g.getUTCMonth() + 1, S = g.getUTCDate(), T = -1, H = -1, L = ae("wm-ipp-base");
            if (L.attachShadow) {
                var A = L.attachShadow({
                    mode: "closed"
                });
                for (se = A; L.children.length > 0; )
                    A.appendChild(L.children[0]);
                if (u)
            ...
            function N() {
                var e = ae("donato").offsetHeight + (ae("wm-ipp-inside").offsetHeight - ae("wm-capinfo").offsetHeight);
            ...
            var j = !1
              , U = !0
              , I = null === (f = ae("donato-if")) || void 0 === f ? void 0 : f.contentWindow
              , P = ae("donato");
            if (console.debug("$donato = %o", P),
            P)
            ...
            ae("wm-tb-close").addEventListener("click", (function(e) {
                ae("wm-ipp-inside").style.display = "none",
                e.preventDefault(),
                N()
            }
            ));
            ...
            q.onmousemove = function(t) {
                ...
                (void 0 !== r.getBoundingClientRect ? r.getBoundingClientRect() : {
                    top: 0,
                    left: 0
                }).left + (window.scrollX || i.scrollLeft) - (i.clientLeft || 0)), h = Math.min(Math.max(0, c - u), e), f = h % n, p = Math.floor(h / n), v = Math.min(11, Math.floor(f / o)), g = 12 * p + v, w = f % 2 == 1 ? 15 : 1, b = x(p + l) + x(v + 1, 2) + x(w, 2) + "000000";
                ae("displayYearEl").innerHTML = p + l,
                ae("displayMonthEl").innerHTML = M(v);
                var S = y + b + "/" + s;
                if (ae("wm-graph-anchor").href = S,
                T != p) {
                    var C = p * n;
                    d.style.left = C + "px",
                    T = p
            ...
            if (W.getContext && W.getContext("2d")) {
                v("GET", "/__wb/sparkline?output=json&url=" + encodeURIComponent(s) + (r && "&collection=" + r || ""), (function(n) {
                    if (200 == n.status) {
                        for (var o = te.parse(n.responseText), r = o.years, i = Object.getOwnPropertyNames(r), a = o.years = [], c = 0; c < i.length; c++) {
                            var u = i[c];
                            r[u] && a.push([u, r[u]])
                        }
                        !function(e) {
                            for (var t = ae("wm-nav-captures"), n = 0, o = e.years, r = e.first_ts, i = e.last_ts, a = 0; a < o.length; a++)
                                for (var l = o[a][1], c = 0; c < l.length; c++)
                                    n += l[c];
                            ...
                            h.innerText = "".concat((u = n,
                            ("" + u).replace(/\B(?=(\d{3})+$)/g, ",")), " ").concat(n > 1 ? "captures" : "capture");
                            var f = _(r, "%d %b %Y");
                                ...
                                for (var m = (c - 1) / 12, v = 0; v < h.length; v++) {
                                    ...
                                    for (var y = h[v][1], g = T(d) + 1, w = 0; w < 12; w++) {
                                        ...
                                        if (b > 0) {
                                            ...
                                            a.fillRect(Math.round(g), Math.ceil(n - S), Math.ceil(m), Math.round(S))
                                        }
                                        g += m
                                    }
                                }
                ...
                var X = new Image;
                X.src = "/__wb/sparkline?url=" + encodeURIComponent(s) + "&width=" + e + "&height=" + t + "&selected_year=" + w + "&selected_month=" + b + (r && "&collection=" + r || ""),
                X.alt = "sparkline",
                X.width = e,
                X.height = t,
                X.id = "sparklineImgId",
            ...
            ae("wm-share-facebook").onclick = function(e) {
                ...
                return ne("https://www.facebook.com/sharer/sharer.php?u=" + encodeURIComponent(t), "", "height=400,width=600"),
                e.preventDefault(),
                !1
            }
            ,
            ae("wm-share-twitter").onclick = function(e) {
                var t = this.dataset.url;
                return ne("https://twitter.com/intent/tweet?text=" + encodeURIComponent(t) + "&via=internetarchive", "", "height=446,width=600"),
                e.preventDefault(),
                !1
            }
            ,
            new $(ae("wmtbURL"),{
                ...
                source: function(e, t) {
                    v("GET", "/__wb/search/host?q=" + encodeURIComponent(e), (function(n) {
                        if (void 0 !== (n = te.parse(n.response)).hosts && n.hosts.length > 0) {
                            var o = Y(n.hosts);
                            t(o)
                        } else
                            void 0 !== n.isUrl && !0 === n.isUrl && void 0 === n.excluded ? t([e]) : v("GET", "/__wb/search/anchor?q=" + encodeURIComponent(e), (function(e) {
                                if (void 0 !== (e = te.parse(e.response)) && e.length > 0) {
                                    var n = Y(e.slice(0, 5));
                                    t(n)
                                }
                            }
            ...
            ae("wmtb").onsubmit = function(e) {
                ...
                if (0 !== t.indexOf("http://") && 0 !== t.indexOf("https://") && !t.match(/[\w\.]{2,256}\.[a-z]{2,4}/gi))
                    return document.location.href = "/web/*/" + ae("wmtbURL").value,
                    e.preventDefault(),
                    !1
            }
            ,
            function(e, t) {
                !function(e, t, n) {
                    ...
                    e ? (ae("wm-screenshot").title = "screen shot (delta: " + t + "s)",
                    fe("wm-screenshot", !0)) : fe("wm-screenshot", !1)
                }
                ))
            }(s, le),
            h && function(e, t) {
            ...
            if (J)
                if ("api" == J.getAttribute("source")) {
                    var G = "https://wayback-api.archive.org/services/context/notices?url=".concat(encodeURIComponent(s), "&timestamp=").concat(le);
                    re(G, {
                        credentials: "omit"
                    }).then((function(e) {
                        return e.json()
                        ...
                        if ("success" == t && (null == n ? void 0 : n.length) > 0)
                            try {
                                ...
                                o.setAttribute("style", "background-color:#666;color:#fff;font-weight:bold;text-align:center"),
